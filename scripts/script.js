window.onload = function () {
    ...
    var slidebg = new Vue({
        ...
        data: {
            introduction_image: 'images/hub.png',
            counter: 1
        },
        ...
        methods: {
            change: function () {
                ...
                if (this.counter == 1) this.introduction_image = 'images/hub_3.png';
                if (this.counter == 3) this.introduction_image = 'images/hub_4.png';
                if (this.counter == 5) this.introduction_image = 'images/hub_5.png';
                if (this.counter == 6) this.introduction_image = 'images/prison_spawn_2.png';
                if (this.counter == 7) this.introduction_image = 'images/hub.png';
                if (this.counter == 8) this.introduction_image = 'images/hub_2.png';
                if (this.counter == 9) this.introduction_image = 'images/hub_3.png';
                if (this.counter == 10) this.introduction_image = 'images/prison_spawn_3.png';
            }
        },
        computed: {
        }
